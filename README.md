...
1. Compute pairwise DTW distances between the 5 genuine signatures. this will give us 25 dtw distances. these can then be used to compute an average distance and standart variation to each other.
